...
import com.zsgj.mobileinspect.adapter.NoticesAdapter;
import com.zsgj.mobileinspect.bean.Notice;
import com.zsgj.mobileinspect.bean.Notices;
...
public class NoticesActivity extends BaseActivity {
	...
	private void getNoticesInfoList(final boolean headerOrFooter) {
		...
		if(AppConfig.isLogin){
			params.addQueryStringParameter("syjCode", MyApplication.instance.getSyjUser().getSyj().getCode());
		}else{
