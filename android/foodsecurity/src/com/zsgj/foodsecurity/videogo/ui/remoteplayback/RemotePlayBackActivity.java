 ...
 * @warning 这里写本文件的相关警告
 */
package com.zsgj.foodsecurity.videogo.ui.remoteplayback;
...
import com.zsgj.foodsecurity.videogo.utils.VerifySmsCodeUtil;
import com.zsgj.foodsecurity.widget.HVScrollView;
...
//        
    ...
    private void handleSearchCloudFileSuccess(Calendar seletedTime) {        
        ...
        if(mAlarmStartTime != null) {
            mRemotePlayBackHelper.searchRemotePlayBackFileTask(mRemotePlayBackMgr, mCameraInfo.getCameraId(), 
                    null, seletedTime!=null?seletedTime:mAlarmStartTime, mAlarmStopTime);
        } else {
            mRemotePlayBackHelper.searchRemotePlayBackFileTask(mRemotePlayBackMgr, mCameraInfo.getCameraId(), 
                    null, seletedTime!=null?seletedTime:mStartTime, mEndTime);
        }
    }
